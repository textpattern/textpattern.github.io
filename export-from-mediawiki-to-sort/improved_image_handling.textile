...
bc(code). <txp:article_image> <txp:article_thumbnail>


Sets source to the article&#95;image field. Displays full image and thumbnail respectively.

bc(code). <txp:custom_field_image> <txp:custom_field_thumbnail>
...
bc(code). category="//category_name//"
...
bc(code). sort_dir="//sort direction//"
