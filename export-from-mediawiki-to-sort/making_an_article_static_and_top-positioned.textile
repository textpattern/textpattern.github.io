...
bc(code). <[[txp:article_:|txp:article status="sticky" /]]>
...
bc(code). <[[txp:recent_articles_:]]>


<p>,</p>
bc(code). <[[txp:related_articles_:]]>
...
bc(code). Admin panel > presentation > sections
...
bc(code). Admin panel > content > write
...
bc(code). Admin panel > presentation > forms
...
bc(code). Admin panel > content > articles
...
bc(code). ...mydomain.com/textpattern/index.php?event=article&step=edit&ID=3
...
bc(code). <!-- an article from another section -->
