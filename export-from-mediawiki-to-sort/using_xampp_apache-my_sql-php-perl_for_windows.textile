...
bc(code). c:\> md5sum -c xampp-win32-1.5.3a.exe.md5
...
bc(code). c:\xampp> xampp-win32-1.5.3a.exe
...
bc(code). C:\xampp>xampp_start.exe
...
bc(code). #LoadModule rewrite_module modules/mod_rewrite.so
...
bc(code). 127.0.0.1  local.domain1.tld
