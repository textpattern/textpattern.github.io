...
Within tagbuilders: make time attribute a dropdown list.

This function was added to the core after the release of 4.0.4, in "revision 2072":http://dev.textpattern.com/changeset/2072.

h4(#location_in_source_code). Location in Source Code

"textpattern/include/txp_tag.php":/home/www/zendstudio/dokuwiki/bin/doku.php?id=textpattern:include:txp_tag.php_file :: line 127

h4(#this_page_last_updated). This Page Last Updated

ako 20:42, 20 November 2006 (UTC)

h4(#information_retrieved_from). Information Retrieved From

"$":http://www.ako-k.com/txpref/textpattern/include/txp_tag.php.source.html
