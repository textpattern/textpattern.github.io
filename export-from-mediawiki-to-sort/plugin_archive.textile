...
bc(code). [http://domain.tld/article-title Article Title]
...
bc(code). plugin_file_name-n.n.tld
...
bc(code). [[media:plugin_file_name-n.n.txt|txt]]


bc(code). [[media:plugin_file_name-n.n.zip|zip]]
...
bc(code). ([[:image:plugin_file_name-n.n.tld|man]])
...
bc(code). [[Docs for plugin_file_name Plugin|yes]]
...
bc(code). [http://forum.textpattern.com/viewtopic.php?id=xxxxxx xxxxxx]
