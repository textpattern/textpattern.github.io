...
* "asy&#95;stopdude":http://forum.textpattern.com/viewtopic.php?pid=91739#p91739 - totally transparent to users. Specifically targetted against the current spam-bots/tools.
* "EBL&#95;TXPAkismet":http://forum.textpattern.com/viewtopic.php?id=17689 - uses Akismet to filter comments.
...
bc(code). txp_die('Unable to record the comment. Please contact the publisher of this site, if this problem persists.'
