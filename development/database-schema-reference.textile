...
| flags | smallint (unsigned) | 16-bit value which signals the presence of optional capabilities to the core plugin loader. The four high-order bits 0xf000 are available for private use. "More info":http://www.textpattern.net/wiki/index.php?title=Plugin_Development_Guidelines#Plugin_lifecycle_management_.26_prefs. |
