...
# You should have a "Textpattern Support Forum":http://forum.textpattern.com account, and you should provide your _username_ profile link when registering a prefix.
...
* **(!)** next to a username means the indicated username has adopted all plugins from the original developer.
...
| N | nab/nabrown78, %(warning)nav%, nhn/"Skubidu":http://forum.textpattern.com/profile.php?id=2770 (?), nok/anoke |
