...
* (?) next to a username means no forum profile or website is found and the status of the prefix is questionable. These prefixes could certainly be challenged for new ownership (see guidelines above).
