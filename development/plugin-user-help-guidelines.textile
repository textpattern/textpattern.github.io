...
The following code block is the plugin help template, which takes into account the entire suite of sections indicated above. Copy everything in the block, paste it into your editor, and remove the sections you don't need, if any. Don't get creative beyond that. All Textile formatting is provided already -- with the exception of some options made clear at bottom -- all you have to do is fill in your content in the right locations. A few clarifications about templet items are made at bottom of template.
...
p. This plugin has the following minimum requirements:
...
A few clarifying notes about using the template:
