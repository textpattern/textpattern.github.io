...
All hopeful plugin developers must have a "plugin developer prefix":http://docs.textpattern.io/development/registered-textpattern-developer-prefixes, and there are some guidelines about picking one, so check it out and keep it in mind.
