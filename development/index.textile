...
The "Core callbacks reference":http://docs.textpattern.io/development/core-callback-reference provides complete details for all callbacks used in Textpattern.
