...
h2(#sec4). Implementation

* "Registered Textpattern developer prefixes":http://docs.textpattern.io/development/registered-textpattern-developer-prefixes (These are _not_ available to new plugin authors. You must add yours here. Use only one!)
