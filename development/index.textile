...
All hopeful plugin developers must "register a plugin developer prefix":registered-textpattern-developer-prefixes, and use it in the appropriate locations.
...
The "Core callbacks reference":core-callbacks-reference provides complete details for all callback actions used in Textpattern, organized by public-side, admin-side, plugin, and function- and tag-based callbacks.[2]
