...
* "Plugin template":http://docs.textpattern.io/development/plugin-template (Always use a template when one is available, and there is.)
* "Plugin user-help guidelines":http://docs.textpattern.io/development/plugin-user-help-guidelines  (One of the rules of the road; to ensure your plugin instructions are consistently structured and properly formatted.)
