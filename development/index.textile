...
The "Core callbacks reference":http://docs.textpattern.io/development/core-callbacks-reference provides complete details for all callbacks used in Textpattern.
...
The @pluggable_ui()@ callback is used throughout the core and allows you to redesign or alter the layout of the administration side of Textpattern by targeting any panel's widgets and/or contained controls.[3]
