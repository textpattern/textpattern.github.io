...
** "Modifyiing admin-side panel elements":#sec7-3)
...
Here we put it all together -- functions and arguments to write callbacks -- with a few examples.
...
h3(#sec7-1-1). Adding new elements
...
h3(#sec7-1-2). Adding new elements to existing panel markup
