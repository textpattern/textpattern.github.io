...
** "Public-side functions":#sec6-2
** "Administration functions":#sec6-2
*** "Function: @pluggable_ui()@":#sec6-2-1
*** "Function: @register_callback()@":#sec6-2-1
* "Callbacks":#sec7
** "The register callback":#sec7-2
** "Public-side callback events":#sec7-3
** "Admin-side callback events":#sec7-4
** "The pluggable UI callback events":#sec7-5 (for admin-side layout modifications)
...
h3(#sec6-1). Public-side functions

[todo:intro para for this section]

It is probably not helpful to make a list of public-side functions. If you're comfortable with PHP, you'll figure things out, and the helper functions mentioned above will get you on your way.

What are worth detailing, however, are the relevant administration functions.

h3(#sec6-2). Administration functions

Two functions in particular are notable for admin-side plugins: @register_callback()@ and @pluggable_ui()@. Both of these functions are important for writing "callbacks":http://docs.textpattern.io/development/core-callbacks-reference.
...
|_. Argument |_. Parameter |_. Explanation |
...
The @pluggable_ui@ function is for admin-side plugins solely. It allows you to manipulate the user-interface of the administration side. The function is used throughout the core and allows you to target any panel’s widgets and/or contained controls.[1]
...
Arguments 3, 4, and occasionally 5 are optional depending on what you're trying to do…
...
h4(#sec7-5-1). Adding your own admin-side panel elements
...
h4(#sec7-5-2). Removing admin-side panel elements
...
h4(#sec7-5-3). Changing admin-side panel elements
...
h3(#sec7-3). Public-side callback events
...
h3(#sec7-4). Admin-side callback events

See "Admin-side callbacks":http://docs.textpattern.io/development/core-callbacks-reference#sec2 in the "Core callbacks reference":http://docs.textpattern.io/development/core-callbacks-reference.
