...
* "Callbacks":#sec6
** "[@register_callback()@]":#sec6-1
** "Public-side callback events":#sec6-2
** "Admin-side callback events":#sec6-3
** "@pluggable_ui()@ callback events":#sec6-4 (for admin-side layout modifications)
** "Complete core callback list":#sec6-5
...
h3(#sec6-2). Public-side callback events
...
h3(#sec6-3). Admin-side callback events
...
h3(#sec6-4). @pluggable_ui()@ callback events
...
h4(#sec6-3-1). Adding your own admin-side panel elements
...
h4(#sec6-3-2). Removing admin-side panel elements
...
h4(#sec6-3-3). Changing admin-side panel elements
...
h3(#sec6-5). Complete core callback list
...
* "sed_plugin_help_viewer":http://textpattern.org/plugins/612/sed_plugin_help_viewer (A help viewer plugin that you might find... helpful. Heh!)
...
* "Database schema reference":http://docs.textpattern.io/development/database-schema-reference (If your plugins will need a database table, and it likely will.)
* "Extensions":http://docs.textpattern.io/administration/extensions/ (If your admin-side plugin will provide __Publisher__ controls in it's own panel under **Extensions**, and it likely... you know.)

**Miscellaneous tools:**

These are questionable until further notice.
