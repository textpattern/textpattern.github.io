...
@PLUGIN_LIFECYCLE_NOTIFY@ and @PLUGIN_HAS_PREFS@ are human-readable defined bit masks you can use in any appropriate combination (@PLUGIN_LIFECYCLE_NOTIFY | PLUGIN_HAS_PREFS@, etc).

Once you flag your intention to use the events, you use the standard @register_callback()@ system to invoke your own code when the event fires:
