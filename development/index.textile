...
Templates come from the trials and errors of those who came before you. Thus using templates helps you do things easier, with better results. There are two templates to be aware of and use: the plugin development template, and the plugin's user-help template.
