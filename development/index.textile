...
h3(#sec6-5). The pluggable_ui callback events

See "Admin-side user-interface callbacks":http://docs.textpattern.io/development/core-callbacks-reference#sec2-4) in the "Core callbacks reference":http://docs.textpattern.io/development/core-callbacks-reference.
