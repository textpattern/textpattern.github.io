...
The arguments for a given function will vary depending on what your functions are for, and whether you're developing a public-side or admin-side plugin.
...
h4(#sec7-). Adding your own admin-side panel elements
...
[todo:harmonize the "admin-side callbacks":http://docs.textpattern.io/development/core-callbacks-reference#sec2 section with the isolated "admin-side events and steps":http://docs.textpattern.io/development/admin-side-events-and-steps]
