...
What we're doing here is checking if the tag's @name@ attribute is equal to "*Admin*". If it is, the conditional branch will execute. If not, the "else":/home/www/zendstudio/dokuwiki/bin/doku.php?id=else branch will run. 
