...
All plugin developers must have a prefix to name their plugins and [use in plugin development](http://docs.textpattern.io/development/plugin-user-help-guidelines).
