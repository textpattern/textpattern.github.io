...
**Clone me.** When cloning a repo, you've made the decision to contribute back to the master repo branch, or whatever repo you may have cloned from. Cloning puts a copy of the repo on your local drive, where you can work on code on your own time and at your own pace. When ready to share back, you make a _pull request_, which is basically a request to the branch manager to merge your edits to the master repo's code. The branch manager can choose not to if your code is sketchy, but generally the intent is to collaborate harmoniously toward the good of all things.
