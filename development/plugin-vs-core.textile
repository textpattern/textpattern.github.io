...
Unlike core code, which is maintained in a centralized "Textpattern repository":http://docs.textpattern.io/development/fetching-dev-version-of-txp as core developers come and go, plugins tend to have short lifespans and fall out of use. This is usually due to one of a two situations:
