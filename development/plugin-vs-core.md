...
Unlike core code, which is maintained in a centralized [Textpattern repository](http://docs.textpattern.io/development/textpattern-source-code-repositories) as core developers come and go, plugins tend to have short lifespans and fall out of use. This is usually due to one of a two situations:
...
If you're [using plugins](http://docs.textpattern.io/administration/plugins-panel), make sure you're using plugins from reliable sources and developers. Do the background checking before you install anything.
...
If you're [developing plugins](http://docs.textpattern.io/development/), make sure your not reinventing the wheel, and your code is good (following Textpattern best practices). And when time comes to abandon them, make it clear at all your plugin source locations that they are no longer supported - a common courtesy for the community.

[^1]: If you're developing plugins, make sure you understand the related [Disclaimer](http://docs.textpattern.io/development/#disclaimer).
