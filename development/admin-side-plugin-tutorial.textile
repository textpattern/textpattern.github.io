...
This tutorial walks you through the basics of creating and admin-side plugin, covering functions, callbacks, and the concept of __events__ and __steps__. This tutorial assumes you have a working knowledge of PHP, a Textpattern website ready for use, and the ied_plugin_composer plugin installed.
