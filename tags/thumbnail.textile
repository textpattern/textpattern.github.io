...
The *thumbnail* tag is a _single_ tag that Textpattern will replace with the @<img src="...">@ HTML tag matching the thumbnail image of the numeric @id@ assigned by Textpattern when the parent image was uploaded via the Textpattern "Images administration panel":../administration/images-panel.
