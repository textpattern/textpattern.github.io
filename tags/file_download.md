...
The **file_download** tag is a *single* tag which Textpattern will replace with Textpattern 'file' type [Form templates](https://docs.textpattern.io/themes/form-templates-explained). Inside that form go the other [file tags](https://docs.textpattern.io/tags/file-tags).
