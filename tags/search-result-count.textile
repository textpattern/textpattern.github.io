...
p(alert-block information). Note: The "if_search":if-search conditional tag is required to recognize actual search results, without them the number of articles is returned by default.
