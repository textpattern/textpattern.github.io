...
Restrict to specified category. Note: the category name may be different to the title you typed when you created the category, as the names are sanitised for URL use. Check the [[Categories administration panel]] to ensure you are using the correct name.
Value: category name.
