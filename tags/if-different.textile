...
To be used inside a Textpattern 'article' type [[Form template]] or an article tag container (such as "article":article.textile or "article_custom":article-custom.textile).

Other tags used: "posted":posted.textile.
...
Other tags used: "article_custom":article-custom.textile, "section":section.textile, "title":title.textile.
