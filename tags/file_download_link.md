...
`filename="text"`
: Specifies which file to display by its `filename` as shown on the [Files administration panel](http://docs.textpattern.io/administration/files-panel).

`id="integer"`
: Specifies the `id`, assigned at upload of the file, to display. Can be found on the [Files administration panel](http://docs.textpattern.io/administration/files-panel).
