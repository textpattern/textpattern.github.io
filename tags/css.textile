...
The basic *css* tag is a _single_ tag used to output the URL of the stylesheet assigned in the Textpattern "Sections administration panel":../administration/sections-panel.
