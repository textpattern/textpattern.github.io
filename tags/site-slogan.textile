...
The *site_slogan* is a _single_ tag which is used to output the site's tagline (labeled as 'Site slogan' in the "Preferences administration panel":../administration/preferences-panel).
