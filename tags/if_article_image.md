...
The tag will execute the contained statements if an image is associated (through the [Write panel](https://docs.textpattern.io/administration/write-panel) 'Article image' field) with the article being displayed.
