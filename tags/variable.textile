...
p(alert-block information). Note: Avoid entering white space characters for better code readability between the opening and closing _variable_ tags, they will lead to falsified results in the "if_variable":if-variable.textile evaluation.
...
Other tags used: "else":else.textile, "if_category":if-category.textile, "if_search":if-search.textile, "if_variable":if-variable.textile, "search_term":search-term.textile.
...
Other tags used: "if_variable":if-variable.textile.
