...
Each Textpattern tag is described in detail on its respective reference page. See [Tag basics](/tags/tag-basics/) for overview of tag types and modes of use. For a complete list of tag attributes see [Tag attributes cross-reference](/tags/tag-attributes-cross-reference).
