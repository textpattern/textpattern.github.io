...
The *posted* tag is a _single_ tag which is used to return the publish date of the article being displayed. The format is determined by the settings specified in the 'Date format' or 'Archive date format' fields in the "Preferences administration panel":../administration/preferences-panel.
