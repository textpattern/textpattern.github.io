...
* @id="integer"@
Specifies the @id@, assigned at creation of the link, to display. Can be found on the [[Links page]]. If both @name@ and @id@ are specified, @name@ is used while @id@ is ignored.
* @name="link name"@
Specifies which link to display by its link @name@ as shown on the [[Links page]].
* @rel="relation"@
