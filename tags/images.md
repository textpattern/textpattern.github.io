...
: Filter the images by this list of category names as defined in the [Categories panel](https://docs.textpattern.io/administration/categories-panel).
...
`id="integer"`
: Filter the images by this list of `id`s assigned at upload. The IDs can be found on the [Images panel](https://docs.textpattern.io/administration/images-panel).
...
`name="image name"`
: Filter the images by this list of image names as shown on the [Images panel](https://docs.textpattern.io/administration/images-panel).
: **Default:** unset.
