...
The *comments_invite* tag is a _single_ tag which is used to display a link to an article comment form. Text used for the link will be taken from the invitation field on the Textpattern [[Write administration panel]].
