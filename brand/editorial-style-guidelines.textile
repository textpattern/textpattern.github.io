...
British English aside, we favor the serial comma (aka, the "Oxford comma"). If you use them every time, you won't be wrong, even if you don't need one. For example, both forms of this sentence are correct, and the serial comma is used in the second:
...
p. But the opposite is not true. Sometimes a missing serial comma changes the meaning considerably, and there are poignant examples to demonstrate this:

bq. I saw Bob's uncle, a boozer and a cruiser in the park, run into the corner deli.

Poor Bob's uncle. So, generally speaking, use a serial comma.

h3(#sec2-2). Quotations marks

We won't get complicated here, but a closing quotation mark should most often be _inside_ of the trailing punctuation of a clause or phrase, not outside.[1] 

Tip: Be mindful when writing Textile links that your text editor is using straight quotation marks, not curly quotation marks. While the latter are attractive for regular text copy, they won't work for links. Thus straight quotations marks may prove best for documentation portability over the long-term. So you'll have quote marks looking like this:

bc. The link label reads "see more", but see more of what?

Instead of this:

bq. The link label reads “see more”, but see more of what? 

fn1. See "$":http://en.wikipedia.org/wiki/Quotation_mark if you really have nothing better to do.

h2(#sec3). Point of view (personal pronouns)

Write in the *second-person point of view only*, not first-person or third-person. Most of the words you'll use are "you", "your", and "yours" when talking to the reader.

For example:

bq. You can change the default landing panel in **Basic** preferences.

Do not write in the first-person point of view, regardless of whether the pronouns are normative, objective, or possessive. In other words, you should never be using these: I/we, me/us, my, mine, our, ours. It's easy to forget and start using "we" and "us", as if you and the reader are working through a problem together. But don't do that. Take the second person stance and empower the reader. Make them feel like their doing it alone by your instruction, because they are. Change "we" to "you", or "our" to "your". 

Likewise, do not use the third-person in your copy. So not these words: he, she, they … him, her, them … his, her, hers, their, theirs … it. Too indirect and totally unnecessary.

h2(#sec3). Latin and foreign expressions

In short, don't use them, with exception to the situations noted for __Latin__. Stick with simple and concise English and your copy will be easier for people to understand and translate, if they desire.

h3(#sec3-1). Latin

Avoid using __Latin__ in course of regular phrases, whether abbreviations or full words -- with the exception to these words, which are fine: "via" and "versus". 

Instead, use common __Latin__ abbreviations _only_ (in other words, "e.g." and "i.e.") in parenthetical phrases or clauses.

For example, don't do this:

bq. The **Content** region panels included **Write**, **Articles**, **Images**, **Links**, etc. [or et cetera.]

Instead, either put the __Latin__ in a parenthetical clause and shorten the list of items to three max:

bq. The **Content** region contains all the content panels (**Write**, **Articles**, **Images**, etc.).

Or replace the __Latin__ and parenthetical clause entirely for a regular English expression:

bq. The **Content** region contains all the content panels, like **Write**, **Articles**, **Images**, and so forth.

You don't have to italicise Latin abbreviations in parenthetical breaks, as described, but you do have italicise any __Latin__ used in the normal sentence, if you use it there at all.
