...
Textpattern is spelled "*Textpattern*". Look at that closely. There is no capital "p". This isn't WordPress, or any other number of CMSes that have camel-case names. Nope. Textpattern is all one word. One capital letter. To put it another way: %(error)WRONG!% → TextPattern.
