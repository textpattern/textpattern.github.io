...
Textpattern's default language is English, and follows the conventions provided by Oxford University Press resources, including the "Oxford English Dictionary":http://www.oed.com. All Textpattern platforms designate this choice of English usage in the language tags of website templates:
...
The following table compares British (en-GB), American (en-US), and Canadian English conventions with Oxford English Dictionary (en-GB-oxendict) choices relative to different types of word structure.[2] Use the Oxford conventions when writing Textpattern content.
...
erbs ending in “-ize” (en-US) and their related forms should be written with an "s" instead:
