...
# It's a measure easier for future Txp authors/editors who come from a significant part of the English-speaking world that uses the same conventions.[1]
...
fn1. And there's the fact Textpattern's creator, Dean Allen, is Canadian, and Canada uses _-ize_ verb spellings instead of _-ise_, for example, as defined in Oxford usage.
