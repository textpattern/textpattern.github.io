...
# It normalizes the effort to create copy (due to Oxford rules being a fair compromise across British and American English conventions), so one group of writers/editors doesn't have the upper hand on the other. Oxford rules may, in fact, be the most "International" form of English usage.
...
The following table compares conventional patterns of spelling between North American regions, Great Britain, and the Oxford English Dictionary.[1] The words shown are simply representative of all possible words having those respective patterns. Use the Oxford conventions (*en-GB-oxendict*) when writing Textpattern content.
...
Use double quotation marks when quoting text, such as admin-side UI form control labels and options, and put the closing quotation mark _inside_ the end punctuation of a clause or full phrase:[4] 

bq. Your domain name goes in "Site URL".

, unless the quoted part has it's own punctuation

 Also, when quoting a quotation, use double quotation marks for the outer quote, and single quotation marks for the inner quote.
...
fn4. See section on __User-interface content__ for UI text formatting conventions.
