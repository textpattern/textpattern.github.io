...
The following table compares conventional patterns of spelling between North American regions, Great Britain, and the Oxford English Dictionary (*en-GB-oxendict*).[2] The words shown are simply representative of all possible words having those respective patterns. Use the Oxford conventions when writing Textpattern content.
