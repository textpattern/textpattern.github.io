...
# It's a measure easier for future Txp authors/editors who come from a significant part of the English-speaking world that uses the same conventions. (And there's the fact Dean Allen, Textpattern's creator, is Canadian, and Canada uses _-ize_ verb spellings instead of _-ise_, for example.)
