...
h2(#lang). Language (International English conventions)

Textpattern's default language is English, and all written copy follows conventions provided in resources by the Oxford University Press, including the "Oxford English Dictionary":http://www.oed.com. All Textpattern platforms designate this choice of English usage in the language tags of website templates:
...
p. By adopting the Oxford way for Textpattern's international English copy, four main benefits are gained:
...
# It's definable in metadata to a more precise level: lang="en-GB-oxendict", because even in Great Britain there's an increasing degree of variation in how words are spelled and punctuation is used.
# It's a measure easier for future Txp authors/editors who come from a significant part of the English-speaking world that uses the same conventions. (And there's the fact Dean Allen, Textpattern's creator, is Canadian, and Canada uses -ize spellings, for example.)
# It normalizes the effort to creating copy (due to Oxford rules being a fair compromise across British and American English conventions), so one group of writers/editors doesn't have the upper hand on the other. It may in fact be the most "International" form of English usage.

The rest of these guidelines will specify conventions in context to topics.

h2(#spell). Spellings

There are many differences between British and American English with respect to how words are spelled.[999] However, history shows these differences become fewer as time goes by, so only worry about the following if you're used to writing in American English.

Verbs ending in “-ize” (en-US) and their related forms should be written with an "s" instead:

* organise, organiser, organisation, organisational…
* italicise, normalise, hypothesise, and so forth

Nouns and adjectives ending in "-or" (en-US) should be written with "-our" instead:

* colour, behaviour, harbour, flavour, and the like

Certain nouns and adjectives ending in "-er" should be written with "-tre" instead. These are likely the ones to watch out for:

* metre, centre 

fn999. See "$":https://en.wikipedia.org/wiki/American_and_British_English_spelling_differences
