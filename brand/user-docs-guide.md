...
* {: .directory} <span class="ui-icon ui-icon-folder-collapsed">Directory:</span> parent_directory
  * {: .directory} <span class="ui-icon ui-icon-folder-collapsed">Directory:</span> child_directory1
  * . . .
  * {: .directory} <span class="ui-icon ui-icon-folder-collapsed">Directory:</span> child_directory4
    * {: .document} <span class="ui-icon ui-icon-document-b">File:</span> file1.ext
    * {: .document} <span class="ui-icon ui-icon-document-b">File:</span> file2.ext
    * {: .document} <span class="ui-icon ui-icon-document-b">File:</span> file3.ext
  * . . .
{: .list--tree}
