...
The actual diagnostics information is displayed in the **Diagnostics info** region at the bottom of the panel display. The volume of details displayed may be set to "Low" (the default) or "High", which you can toggle between using the **Detail** selection control under the info display field.
...
| Document root: | The path to the installation directory relative to the user directory on server. |
| $path_to_site: | The path to the installation directory relative to the user directory on server. |
| Textpattern path: | The absolute path to your installation's configuration directory. |
| Permanent link mode: | The pattern of URL type you set in "**Preferences**":preferences/preferences-panel. |
| Temporary directory path: | The path of __tmp__ directory relative to web root. |
| Site URL: | Your domain and TLD (i.e. domain.tld); corresponds with setting in "**Preferences**":preferences/preferences-panel. |
| PHP version: | The version number of your PHP install. |
| GD Graphics Library: | |
| Server TZ: | Your web server's time zone (i.e., relative to where it's located). |
| Server local time: | The local date/time you have set in "**Preferences**":preferences/preferences-panel. |
| DST enabled?: | Whether Daylight Savings Time is enabled or not ("0"=no, "1"=yes); corresponds with setting in "**Preferences**":preferences/preferences-panel. |
| Automatically adjust DST setting?: | Related with DST setting in "**Preferences**":preferences/preferences-panel ("0"=no, "1"=yes). |
| Time zone: | Your time zone in Greenwich Mean Time (GMT); corresponds with setting in "**Preferences**":preferences/preferences-panel. |
...
| RFC 2616 headers: | |
| Server OS: | |
| Active plugins: | A comma-separated list of all plugins (and their version numbers) that are installed _and_ turned *ON*. |
| Admin-side theme: | The name and version number of the active administration side theme; default is Hive. |
