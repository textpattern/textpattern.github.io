...
Several warning messages are possible. Where no description is given below, you are advised to look at the UI information for the warnings by clicking the "Information" icon at right of the **Pre-flight check** items:
...
* %(warning)Site URL has a trailing slash% -- [todo:explanation]
