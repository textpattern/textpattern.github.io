...
* %(error)Textpattern requires at least version {version} of PHP to be installed on your server% -- [todo:explanation, where {version} is the recommended version number] 
