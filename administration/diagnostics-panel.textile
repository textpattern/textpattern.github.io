...
* %(warning)DNS lookup failed: {site URL}% -- This means the "Site URL" preference you have entered in the "**Preferences**":preferences/preferences-panel panel is probably incorrect somehow. Check the value and make sure it's entered exactly like this, @domain.tld@, using your domain name and TLD extension.
