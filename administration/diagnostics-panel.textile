...
| GD Graphics Library: | |
| Server TZ: | The time zone of your server, specified by the Greenwich Mean Time location (e.g., Europe/Paris). |
| Server local time: | The local date/time of your server (yyyy-mm-dd hh:mm:ss). |
