...
Blue messages are informational only. They make you aware of something simply so you're informed about it, not because it's a functional problem you need to troubleshoot, necessarily. 
...
* %(warning)DNS lookup failed: {site URL}% -- This means the "Site URL" preference you have entered in the **"Basic":preferences/basic-prefs-panel** panel is probably incorrect somehow. Check the value and make sure it's entered exactly like this, @domain.tld@, using your domain name and TLD extension.
