...
The **Diagnostics** panel is an important panel for troubleshooting potential problems with your Textpattern installation, such as you might discover when installing or upgrading to a new version. They can also be useful for troubleshooting functional problems that you may have introduced by accident when extending the system, modifying the .htaccess file, or some other slight of hand.
