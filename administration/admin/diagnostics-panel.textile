...
The actual diagnostics information is displayed in the **Diagnostics info** field. The volume of details displayed may be set to "Low" (the default) or "High", which you can toggle between using the **Detail** selection control at bottom of the info display field. The convenience of having all this data immediatly available in the **Diagnostics** panel for quick reference is invaluable, which you'll realise more over time.

h3. Low info display

Low diagnostics info begins with a set of data values about your installation and web server technology. A few value descriptions are provided here for general understanding, but most should be obvious.
