...
This is the message you always want to see when you visit the **Diagnostics** panel. The green feedback message displays when you successfully address and/or troubleshoot all, blue, yellow, and red feedback messages that might exist. _Go green!_

h3. Blue (time to update)

There is only one blue message: 

<span style="font-style:italic; background-color:#e7f6fc;">New Textpattern version n.n.n "available for download":http://textpattern.com/download.</span> (where "n.n.n" is the latest version number)

As it suggests, you get this message when your version of Textpattern is not current. For security reasons, you should update as soon as possible. When you do, your diagnostics will show some yellow messages needing addressed.
