...
Yellow messages are not critical emergencies, per se, and sometimes can even be cascading error messages[1], or not be errors at all.[2] They usually appear when you need to remove the __/update__ directory after updating your installation, need to change rights of access for a content directory on your server[3], or when there's a problem of some kind with your site identity or path. 
