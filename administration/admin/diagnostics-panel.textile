...
* <span style="color:#cb8f02; background-color:#fff6d3;">/usr/home/{username}/public_html/textpattern/setup/ still exists</span> (means you need to remove the "setup" folder from the web server) 
* <span style="color:#cb8f02; background-color:#fff6d3;">image directory is read-only</span> (means permissions on your images folder needs changed before you can add any images to it; change permissions to chmod 755 or 711.[3]
...
* <span style="color:#e2062c; background-color:#fccfd4;">Clean URL test failed</span> -- This is not necessarily an error that will prevent your site from working. It could be caused by the PHP configuration setting of @allow_url_fopen@ or some other hosting issue.
