...
* <span style="color:#cb8f02; background-color:cornflower;">/usr/home/{username}/public_html/textpattern/setup/ still exists</span> (means you need to remove the "setup" folder from the web server) 
