...
"Main ToC":http://docs.textpattern.io &#10784 **"Textpattern administration":http://docs.textpattern.io/administration/** &#10784 **Admin** &#10784 **Users**
...
TXP Magazine's "Peaple":http://txpmag.com/people are an example of where these plugins are used to extend user account management and publish that information on the front-side.
