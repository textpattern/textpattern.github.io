...
* "smd_bio":http://forum.textpattern.com/viewtopic.php?id=31496 -- This plugin extends the user account data itself, so you can create user bios and profiles having any data structure you want and display that data on the front-side of a website. 
