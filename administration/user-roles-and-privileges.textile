...
*Frozen accounts.* Frozen accounts are those potentially having the status of "None", meaning the accounts are preserved but the account holders are denied access to the administration side. This is useful for account holders that published content at one point (e.g., Copy Editor, Staff Writer...) but later left the editorial team. The account holder's content will remain safely on the public side of the website under the account holder's name, but they will no longer have administration access to it.
