...
[^5]: Good places to look and learn about building sophisticated publishing architectures with core functionality include: [Tags reference](https://docs.textpattern.io/tags/) (notably the examples provided on each tag page), [Textpattern Tips](http://www.textpattern.tips/), all throughout the support forum, but notably in the [How? area](http://forum.textpattern.com/viewforum.php?id=5).
