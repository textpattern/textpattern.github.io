...
[^5]: Good places to look and learn about building sophisticated publishing architectures with core functionality include: [Tags reference](http://docs.textpattern.io/tags/) (notably the examples provided on each tag page), [TXP Tips](http://txptips/com), all throughout the support forum, but notably in the [How? area](http://forum.textpattern.com/viewforum.php?id=5).
