				...
				<tfoot>
					<tr><td colspan="8">
						<ol class="list--refmarks">
							...
							<li>Limited rights -- The role has access to panel but can only see or use some of the panel's functionality. See [Limited access specifications](#limited-access-specifications).</li>
