...
| |_. What you see and do on this panel |
| **Articles** | Provides a table listing of all articles, and the ability to open one in full-edit mode in context of the **Write** panel. |
| **Categories** | Provides functionality to create and manage topic categories for articles, images, links, and files. |
| **Comments**[2] | Provides a table of all article comments received, and functionality to manage edit them. |
| **Files** | Provides a table listing of all files uploaded and functionality to manage them. |
| **Images** | Provides a table listing of all images uploaded, and functionality to manage them. |
| **Links** | Provides a table listing of all links uploaded and functionality to manage them. |
| **Write** (default) | Provides article editing fields and controls; is the primary content editor in Textpattern. |
...
| |_. What you see and do on this panel |
| **Forms**[3] | Provides a list of forms by type (Textpattern forms, not web forms for submitting data) and functionality to create and manage them. The "default" **Article** form type displays by default. |
| **Pages** (default) | Provides a list of HTML page templates and functionality to create and manage them. The "default" page displays by default. |
| **Sections** | Provides a table listing of sections and functionality to create and manage them. |
| **Styles** | Provides a list of CSS style files and functionality to create and manage them. The "default" style displays by default. |

notextile. </div>

fn3. "Forms" may one day be renamed to "Partials" to better suggest their nature, but core developers have made it clear the change is not on their list of priorities. 
...
| |_. What you see and do on this panel |
| "**Diagnostics**":http://docs.textpattern.io/administration/diagnostics-panel | Provides feedback messages and data displays to troubleshoot system problems. |
| **Import** | Provides functionality to import data from another publishing system. |
| **Languages** (Update languages)[4] | Provides a list of language packs and the ability to update them. |
| "**Plugins**":http://docs.textpattern.io/administration/plugins-panel | Provides a table listing of installed plugins, and functionality to manage them. |
| **Preferences** (basic/advanced)[4] | Provides all configurable settings to make your site function correctly and as desired. |
| "**Users**":http://docs.textpattern.io/administration/users-panel (default) | Provides a table listing of all user accounts, and the functionality to manage them. |
| "**Visitor logs**":http://docs.textpattern.io/administration/visitor-logs-panel | Provides a display of all site traffic. |
