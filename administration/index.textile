...
The "**Extensions**":http://docs.textpattern.io/administration/extensionswill region is not an out-of-the-box feature of Textpattern, but it will appear to the higher "user roles":http://docs.textpattern.io/administration/user-roles-and-privileges if any of the admin-side plugins that make use of it are installed. The following table shows a few examples of plugins that use the **Extensions** region. This is not a complete list, nor trying to be -- it's for demonstration purposes only.[5]  

notextile. <div class="tabular-data" itemscope itemtype="http://schema.org/Table">

|_. Plugin |_. Extensions panel label[6] |
