...
The "**Home**":http://docs.textpattern.io/administration/home-region is associated with dashboard development for multi-user websites. If you're not building a multi-user website, you will not be concerned with this, and even then you may not need the plugins that make this region appear.   

h3(#sec3-2). Extensions

The "**Extensions**":http://docs.textpattern.io/administration/extensions-region region is likely one you will see, eventually, because several useful plugins make use of it.
