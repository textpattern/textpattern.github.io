...
You can change the default landing panel to whatever admin-side panel you want. In "**Preferences**":http://docs.textpattern.io/administration/preferences-panel, look under the **Admin** area for "Default administration panel".[6] Use the drop-down menu to select the panel you want, then save.

fn6. The current preference label is, "Default admin tab". Beginning with version 4.6 the label will become "Default administration panel", which is a normalization against "Textpattern guidelines":http://docs.textpattern.io/brand/.
