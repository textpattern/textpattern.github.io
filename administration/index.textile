...
| **Articles** | Provides a table listing of all "articles", which can be filtered by various column data types. Clicking a given article title opens the article in context of the **Write** panel, in full edit mode. |
| **Categories** | Provides functionality to create and manage topic categories for articles, images, links, and files. |
| **Comments**[4] | Provides a table of all article comments received, and functionality to manage edit them. |
...
|_. Panel |_. What you see and do there |
| **Forms**[5] | Provides a list of forms by type (Textpattern forms, not web forms for submitting data) and functionality to create and manage them. The "default" **Article** form type displays by default. |
...
fn5. "Forms" may one day be renamed to "Partials" to better suggest their nature, but core developers have made it clear the change is not on their list of priorities. 
...
|_. Panel |_. What you see and do there |
| "**Diagnostics**":http://docs.textpattern.io/administration/diagnostics-panel | Provides feedback messages and data displays to troubleshoot any system problems. |
