...
<ul>
<li><p>*Server:*</p>
bc(code). textpattern.googlecode.com


<p>&#42; *Initial Path:*</p>
bc(code). /svn/releases/{{Txp current version}}/source/
...
bc(code). /Applications/Utilities/Terminal.app
...
bc(code). cd /my/textpattern/directory/

</li>
<li><p>Run the following command (*Note:* the space and period at the end are necessary!):</p>
bc(code). svn checkout <__yamdwe_nowiki>0</__yamdwe_nowiki>textpattern.googlecode.com/svn/releases/{{Txp current version}}/source .
...
bc(code). svn checkout http://textpattern.googlecode.com/svn/releases/{{Txp current version}}/source /my/textpattern/directory/
...
<ol>
<li>bc(code). cd /my/textpattern/directory/

</li>
<li>bc(code). svn update
