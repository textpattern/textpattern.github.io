...
This function is used to wrap some content in a HTML fieldset element.

This function was added to the core after the release of 4.0.4, in "revision 2088":http://dev.textpattern.com/changeset/2088.

h4(#location_in_source_code). Location in Source Code

"textpattern/lib/txplib_html.php":/home/www/zendstudio/dokuwiki/bin/doku.php?id=textpattern:lib:txplib_html.php_file :: line 610

h4(#this_page_last_updated). This Page Last Updated

ako 20:54, 20 November 2006 (UTC)

h4(#information_retrieved_from). Information Retrieved From

"$":http://www.ako-k.com/txpref/textpattern/lib/txplib_html.php.source.html
...
<li>bc(code). <nowiki>$legend=''</nowiki>

</li>
<li>bc(code). <nowiki>$id=''</nowiki>
