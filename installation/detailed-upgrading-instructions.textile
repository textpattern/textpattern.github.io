...
This tutorial describes how to _manually_ upgrade your existing Textpattern CMS installation to the latest stable release (currently {{Txp current version}}). In brief, you'll backup your current installation, overwrite your existing installation with new package files, update your preference in the [[Languages page]], and address any problems indicated in the [[Diagnostics page]].
