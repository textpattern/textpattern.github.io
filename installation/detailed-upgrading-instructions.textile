...
This step is highly recommended, but optional. It is best to do this on a development server to avoid showing your users error messages. Alternatively, put your site into maintenance mode, using the [http://forum.textpattern.com/viewtopic.php?id=24708 rvm_maintenance plugin].
...
If you do need to update tag or attribute names, the [http://forum.textpattern.com/viewtopic.php?id=27493 smd_where_used plugin] is a great help for quickly finding all instances of a given tag or attribute.
