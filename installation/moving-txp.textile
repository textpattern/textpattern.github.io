...
h1. Moving a Textpattern installation
...
* "Moving between directories on the same server":#sec1
* "Moving between two servers":#sec2

h2(#sec1). Moving between directories on the same server

Textpattern users have been known to install Textpattern in a subdirectory of a web domain (e.g., __domain.tld/subdirectory__) and later decide to relocate the installation to the domain root (i.e., __domain.tld__).
...
h2(#sec2). Moving between two servers
