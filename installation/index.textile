...
The screen will also suggest deleting the __/setup__ directory for security reasons, and troubleshooting your diagnostics. But when first logging in, Textpattern will land you at a location not mentioned in this screen, so here's the optimal course of action to take once you arrive here:

# Use your S/FTP client to connect to your web server. Go to the __/textpattern/setup__ directory, and delete it (and its contents). This eliminates one potential diagnostic warning you would otherwise see later.
