...
# The **Go!** screen said to go to Diagnostics, but you'll actually land on the "**Language preferences**":http://docs.textpattern.io/administration/prefs-languages-panel panel, where you add new languages and change the default, if desired.  
