...
The _zem_event_finish_time_ tag has the following syntactic structure...

bc(code). <txp:zem_event_finish_time />
...
<txp:zem_event_finish_time label="Close" wraptag="" />
