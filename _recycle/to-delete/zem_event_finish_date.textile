...
bc(code). zem_event_finish_date


tag is used as a "Single_Tag":/home/www/zendstudio/dokuwiki/bin/doku.php?id=glossary#single_tag. Used in a zem_event_list form, it returns the contents of the event's finish date field.

h4(#syntax). Syntax

The _zem_event_finish_date_ tag has the following syntactic structure...

bc(code). <txp:zem_event_finish_date />
...
<txp:zem_event_finish_date label="End" wraptag="" />
