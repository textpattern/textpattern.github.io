...
class. It is used to create an instance of the

bc(code). [[textile]]


class so that text can be formated according to the

h4(#location_in_source_code). Location in Source Code

"textpattern/lib/classTextile.php":/home/www/zendstudio/dokuwiki/bin/doku.php?id=textpattern:lib:class_textile.php_file :: line 233

h4(#this_page_last_updated). This Page Last Updated

ako 17:22, 18 October 2006 (UTC)
