...
At the moment there is no direct way, to include enclosure into the feeds. But "zem":https://forum.textpattern.io/viewtopic.php?pid=78251#p78251 is working on using templates for feeds in 4.1 Templated feeds should be used for podcasting.
