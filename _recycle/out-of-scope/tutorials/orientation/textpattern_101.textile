...
*Admin:Plugins* is the spot where you can add some of the external TXP plugins that enthusiasts write to cover various areas they feel are deficient in the basic package. You can find out more about these in the Plugins forum at the "Textpattern CMS support forums":https://forum.textpattern.io/.
