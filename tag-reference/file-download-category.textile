...
The *file_download_category* tag is a _single_ tag that Textpattern will replace with the category of the file to download. Should be used in a file download [[form]].
