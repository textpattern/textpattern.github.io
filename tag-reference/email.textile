...
bc. <ul class="socbar">
    ...
    <li class="ss-icon email"><txp:email email="donald.swain@example.com" linktext="email" /></li>
</ul>

If you're using Symbolset, then you'll know that the @linktext=""@ attribute in the last list item above *has* to be @"email"@ for the glyph to work. Then the CSS must be like this to target both instances of selector use:
...
p. See the "feed_link":feed-link.textile tag for a similar solution for Symbolset's 'rss' glyph.
