...
p(alert-block information). Please note, that "article_custom":article-custom.textile always displays an article list, even when you set it to display only one article. Thus the *if_individual_article* tag will not work with article_custom, you'll have to use the "article":article.textile tag instead.
...
Other tags used: "link_to_prev":link-to-prev.textile, "link_to_next":link-to-next.textile, "next_title":next-title.textile, "prev_title":prev-title.textile, "if_article_list":if-article-list.textile, "older":older.textile, "newer":newer.textile.
