...
A different way of marking the active section can be accomplished by using "section_list":section-list.textile and its attribute @active_class@. While the above snippet will mark the list item, "section_list":section-list.textile will mark solely the link.

Other tags used: "section":section.textile.
