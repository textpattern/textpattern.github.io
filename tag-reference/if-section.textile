...
A different way of marking the active section can be accomplished by using [[section_list]] and its attribute &lt;code&gt;active_class&lt;/code&gt;. While the above snippet will mark the list item, [[section_list]] will mark solely the link.
