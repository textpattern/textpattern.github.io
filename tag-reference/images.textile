...
h3. NB: THESE MAY NOT BE CORRECT ANY MORE DUE TO TAG CHANGES SINCE THE EXAMPLES WERE WRITTEN. NEED VERIFICATION.
...
bc. <txp:images category="birds, mammals" thumbnail="1" sort="category asc">
    ...
    <txp:image_info type="w, h" wraptag="div" class="img_dims" break=" × " />
