...
: Default: depends upon [[Preferences]] setting.
...
; [[wraptag]]=&quot;element&quot;
: HTML element to wrap feed link (e.g., @wraptag="p"@).
...
h3. Example 1: Display an RSS feed link for specific section and category

bc. <txp:feed_link flavor="rss" section="about" category="general" label="XML" wraptag="p" />

h3. Example 2: Container example

bc. <txp:feed_link wraptag="p">
    <img src="/path/to/rss-icon.png" alt="RSS">
</txp:feed_link>

h3. Example 3: Site wide generic RSS feed

bc. <txp:feed_link section="" category="" />
...
h3. Example 4: With Symbolset's 'rss' glyph
...
bc. <ul class="socbar">
    <li><a href"https://twitter.com/xxx" class="ss-icon twit">twitter</a></li>
    <li><a href="https://plus.google.com/xxx" class="ss-icon gplus">googleplus</a></li>
    <li><a href="http://www.linkedin.com/xxx" class="ss-icon in">linkedin</a></li>
...
p. See the "email":email.textile tag for a similar solution for Symbolset's 'email' glyph.
