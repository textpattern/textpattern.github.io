...
The *article_image* tag is a _single_ tag. Textpattern will replace this tag with the @<img src="...">@ HTML(HyperText Markup Language) tag matching the numeric ID or URL assigned when the article is posted.
