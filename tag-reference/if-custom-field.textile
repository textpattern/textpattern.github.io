...
The tag will execute the contained statements if one or more custom fields for a given article have content. The contents of a custom field can be displayed with the "custom_field":custom-field.textile tag.
...
Other tags used: "custom_field":custom-field.textile.
...
Other tags used: "custom_field":custom-field.textile, "else":else.textile.
