...
: Default: @li@ or @div@, depends upon [[Preferences page]] setting for 'Present comments as a numbered list?'.
; [[breakclass]]=&quot;class name&quot; %(warning)deprecated from 4.6.0 onwards%
: HTML @class@ to apply to the @break@ (when value supplied is a tag).
: Default: unset.
; [[class]]=&quot;class name&quot;
...
: Default: @ol@ or unset, depends upon [[Preferences page]] setting for 'Present comments as a numbered list?'.
...
Other tags used: "comments_form":comments-form.textile, "else":else.textile, "if_comments_allowed":if-comments-allowed.textile.
...
Other tags used: "comment_email":comment-email.textile, "comments_form":comments-form.textile, "comment_id":comment-id.textile, "comment_permlink":comment-permlink.textile, "if_comments_allowed":if-comments-allowed.textile.
