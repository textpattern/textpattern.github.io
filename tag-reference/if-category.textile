...
Should be used in a page template; if checking the category in an article form, use "if_article_category":if-article-category.textile.
...
Other tags used: "author":author.textile.
...
Other tags used: "category":category.textile, "else":else.textile, "site_name":site-name.textile.
...
Other tags used: "category":category.textile, "else":else.textile.
...
Other tags used: "category_list":category-list.textile, "recent_articles":recent-articles.textile.
