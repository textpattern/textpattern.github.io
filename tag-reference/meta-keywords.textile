...
p(alert-block information). Note: The corresponding keywords field has a 255 character limit by default, which includes spaces and commas. This is a MySQL database column limit that you may edit using "phpMyAdmin":http://www.phpmyadmin.net, for example.
