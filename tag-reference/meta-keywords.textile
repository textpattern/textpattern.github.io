...
h3. Example 2: Use article's keywords as a raw value (without meta tag)

bc. <p>Keywords: <txp:meta_keywords format="" /></p>

The above will output the keywords as a raw value (not enclosed in a @<meta>@ tag) populated with the list of keywords set in the article's 'Keywords' field.
