...
: Value: (comma separated list of) author login name(s).
...
h3. Example 1: List articles published in specified month
...
h3. Example 3b: Select by author (using container tag)
...
h3. Example 6: Select by article ID(s)
