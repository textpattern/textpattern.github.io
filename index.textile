...
Welcome to the new user documentation, which replaces the old wiki at textpattern.net (soon to retire). This is work-in-progress for a while, but any viewable page is ready for use, albeit subject to further editing. Occasional progress updates and feedback requests will be made in the "sites forum":http://forum.textpattern.com/viewforum.php?id=60.
...
* "Textpattern administration":administration/ (administration structure and functionality)
* "Administration fast-track":administration/admin-fast-track (fast-track workflow to get up to speed)
