...
# FTP installation - The basic (and detailed) .zip file approach.
# Command-line installation - For the jockeys, to write.
# Upgrading, downgrading, nightlies, and bleeding edge.
# Multi-site installation - One install to rule them all.
